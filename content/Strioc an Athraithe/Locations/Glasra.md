...
> |  |  |
> |  ----|  ----|
> | **Region** | Northern [[Strioc an Athraithe]] |
> | **Size** | Small City-State |
> | **Trades** | Produce |
> | **Government** | Gerontocracy |
> | **Religion** | Diverse |

The "kingdom" of Glasra is a haven for many of the youngest and oldest Leshy of Antir. It serves as both a retirement community for elders, and a nursery for the newborns when those elders decide to reincarnate.

# Locations
The "kingdom" is very small, both in territory and the size of its buildings. It mostly consists of a single town, surrounded by a few miles of lush forests. All of the structures in the town - except a single "guest house" - are leshy-sized, and thus very cramped for most other people.
